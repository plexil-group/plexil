        ...
        <Node epx="Do" NodeType="NodeList">
          ...
          <NodeBody>
            <NodeList>
                ...
                <NodeBody>
                  <NodeList>
                    <Node NodeType="Assignment">
                      <NodeId generated="1">ep2cp_Node_d14e82</NodeId>
                      <NodeBody>
                        <Assignment>
                          <IntegerVariable>j</IntegerVariable>
                          <NumericRHS>
                    ...
                    <Node NodeType="Command">
                      ...
                      <StartCondition>
                        <Finished>
                          <NodeRef dir="sibling">ep2cp_Node_d14e82</NodeRef>
                        </Finished>
                      </StartCondition>
                      <NodeBody>
                        <Command>
              ...
              <Node NodeType="Assignment">
                <NodeId generated="1">ep2cp_Node_d14e137</NodeId>
                <StartCondition>
                  <Finished>
              ...
              <Node NodeType="Command">
                ...
                <StartCondition>
                  <Finished>
                    <NodeRef dir="sibling">ep2cp_Node_d14e137</NodeRef>
                  </Finished>
                </StartCondition>
                <NodeBody>
                  <Command>
