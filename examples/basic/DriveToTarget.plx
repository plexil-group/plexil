...
<PlexilPlan xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
            ...
            FileName="DriveToTarget.ple">
   <GlobalDeclarations LineNo="4" ColNo="0">
      ...
      <StateDeclaration LineNo="12" ColNo="8">
   ...
   <Node NodeType="NodeList" epx="Concurrence" LineNo="16" ColNo="0">
            ...
            <Node NodeType="Command" LineNo="17" ColNo="10">
               ...
               <NodeBody>
                  <Command>
                     ...
                     <Arguments LineNo="18" ColNo="22">
                        <IntegerValue>10</IntegerValue>
                     </Arguments>
                  </Command>
               </NodeBody>
            </Node>
            <Node NodeType="NodeList" epx="Sequence" LineNo="21" ColNo="4">
               ...
               <NodeBody>
                  <NodeList>
                     <Node NodeType="NodeList" epx="Concurrence" LineNo="22" ColNo="4">
                        <NodeId>Concurrence__0</NodeId>
                        <NodeBody>
                           <NodeList>
                              ...
                              <Node NodeType="Assignment" LineNo="24" ColNo="22">
