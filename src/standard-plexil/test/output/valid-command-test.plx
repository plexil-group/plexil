  <PlexilPlan xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://plexil.svn.sourceforge.net/viewvc/plexil/trunk/schema/supported-plexil.xsd" FileName="command-test.ple">
      <GlobalDeclarations>
          <CommandDeclaration>
              <Name>foo</Name>
          </CommandDeclaration>
