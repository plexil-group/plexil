...
<PlexilPlan xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
   ...
   <Node NodeType="NodeList" FileName="simulator-string-arrays-test.ple" LineNo="5"
         ColNo="1">
                  ...
                  <AND>
                     ...
                     <NOT>
                        <OR>
                           ...
                           <EQInternal>
                              <NodeOutcomeVariable>
                                 <NodeId>ep2cp_CmdAction_GetName</NodeId>
                              </NodeOutcomeVariable>
                              <NodeOutcomeValue>FAILURE</NodeOutcomeValue>
                           </EQInternal>
                        </OR>
                     ...
                     <Node NodeType="Command">
                        ...
                        <NodeBody>
                           <Command>
                              ...
                              <Arguments>
                                 <StringValue>GetName</StringValue>
                              </Arguments>
                           </Command>
                        </NodeBody>
                     </Node>
                              ...
                              <Node NodeType="Command" FileName="simulator-string-arrays-test.ple" LineNo="13"
                                 ...
                                 <NodeBody>
                                    <Command>
                                       ...
                                       <Arguments>
                                          <StringVariable>ep2cp_hdl</StringVariable>
                                          <ArrayVariable>name</ArrayVariable>
                                       </Arguments>
                                    </Command>
                                 </NodeBody>
                              </Node>
