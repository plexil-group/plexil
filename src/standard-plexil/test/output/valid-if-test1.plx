...
<PlexilPlan xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
   ...
   <Node NodeType="NodeList" epx="If" FileName="if-test1.ple" LineNo="5" ColNo="1">
               ...
               <NodeBody>
                  <NodeList>
                     <Node NodeType="NodeList" epx="Then">
                        ...
                        <NodeBody>
                           <NodeList>
                              <Node NodeType="NodeList" epx="If" FileName="if-test1.ple" LineNo="7" ColNo="19">
                                          ...
                                          <NodeBody>
                                             <NodeList>
                                                <Node NodeType="NodeList" epx="Then">
                                                   ...
                                                   <NodeBody>
                                                      <NodeList>
                                                         <Node NodeType="Command" FileName="if-test1.ple" LineNo="8" ColNo="21">
                                                ...
                                                <Node NodeType="NodeList" epx="Else">
                                                   ...
                                                   <NodeBody>
                                                      <NodeList>
                                                         <Node NodeType="Command" FileName="if-test1.ple" LineNo="11" ColNo="10">
