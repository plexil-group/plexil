...
<StringValue>timeout</StringValue>
                                ...
                                <Node NodeType="NodeList"><NodeId>DriveAndAcquire</NodeId><StartCondition><Finished>
                                    ...
                                    <NodeList>
                                      <Node NodeType="NodeList" epx="If"><NodeId>ep2cp_If_d1e1244</NodeId><NodeBody><NodeList><Node NodeType="Empty" epx="Condition"><NodeId>ep2cp_IfTest</NodeId><PostCondition><NOT><EQNumeric><IntegerValue>0</IntegerValue><IntegerVariable>task_type</IntegerVariable></EQNumeric></NOT></PostCondition></Node><Node NodeType="NodeList" epx="Then"><NodeId>ProcessWaypoint</NodeId><StartCondition><Succeeded><NodeRef dir="sibling">ep2cp_IfTest</NodeRef></Succeeded></StartCondition><SkipCondition><PostconditionFailed><NodeRef dir="sibling">ep2cp_IfTest</NodeRef></PostconditionFailed></SkipCondition><NodeBody>
                                              <NodeList>
...
<StringValue>drive</StringValue>
                                                      ...
                                                      <NodeList>
                                                        <Node NodeType="NodeList" epx="If"><NodeId>ep2cp_If_d1e1446</NodeId><NodeBody><NodeList><Node NodeType="Empty" epx="Condition"><NodeId>ep2cp_IfTest</NodeId><PostCondition><NOT><EQNumeric><IntegerValue>1</IntegerValue><IntegerVariable>task_type</IntegerVariable></EQNumeric></NOT></PostCondition></Node><Node NodeType="NodeList" epx="Then"><NodeId>ep2cp_Sequence_d1e1465</NodeId><InvariantCondition><NOT><OR><Failed><NodeRef dir="child">Cmd_Resest2</NodeRef></Failed><Failed><NodeRef dir="child">TakeSample</NodeRef></Failed><Failed><NodeRef dir="child">SetNameToAcquire</NodeRef></Failed></OR></NOT></InvariantCondition><StartCondition><Succeeded><NodeRef dir="sibling">ep2cp_IfTest</NodeRef></Succeeded></StartCondition><SkipCondition><PostconditionFailed><NodeRef dir="sibling">ep2cp_IfTest</NodeRef></PostconditionFailed></SkipCondition><NodeBody><NodeList><Node NodeType="Assignment"><NodeId>Cmd_Resest2</NodeId><NodeBody>
                                                                  <Assignment>
                                                                    <IntegerVariable>cmd_return_val</IntegerVariable>
                                                                    <NumericRHS>
                                                                      <IntegerValue>-1000</IntegerValue>
...
<StringValue>acquire</StringValue>
                          ...
                          <Node NodeType="NodeList"><NodeId>CheckIfAbortPlan</NodeId><StartCondition><Finished>
                              ...
                              <NodeList>
                                <Node NodeType="NodeList" epx="If"><NodeId>ep2cp_If_d1e1762</NodeId><NodeBody><NodeList><Node NodeType="Empty" epx="Condition"><NodeId>ep2cp_IfTest</NodeId><PostCondition><OR><EQNumeric><IntegerValue>-1</IntegerValue><IntegerVariable>cmd_return_val</IntegerVariable></EQNumeric><EQNumeric><IntegerValue>1</IntegerValue><IntegerVariable>cmd_return_val</IntegerVariable></EQNumeric><EQNumeric><IntegerValue>4</IntegerValue><IntegerVariable>cmd_return_val</IntegerVariable></EQNumeric><EQNumeric><IntegerValue>5</IntegerValue><IntegerVariable>cmd_return_val</IntegerVariable></EQNumeric><EQNumeric><IntegerValue>6</IntegerValue><IntegerVariable>cmd_return_val</IntegerVariable></EQNumeric></OR></PostCondition></Node><Node NodeType="Assignment" epx="Then"><NodeId>SetAbort</NodeId><StartCondition><Succeeded><NodeRef dir="sibling">ep2cp_IfTest</NodeRef></Succeeded></StartCondition><SkipCondition><PostconditionFailed><NodeRef dir="sibling">ep2cp_IfTest</NodeRef></PostconditionFailed></SkipCondition><NodeBody>
                                        <Assignment>
