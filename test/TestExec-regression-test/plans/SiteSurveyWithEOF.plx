                                    ...
                                    <NodeList>
                                                   ...
                                                   <NodeBody>
                                                      <NodeList>
                                                         <Node NodeType="NodeList" epx="If">
                                                            <NodeId>ep2cp_If_d1e1244</NodeId>
                                                            <NodeBody>
                                                               <NodeList>
                                                                     ...
                                                                     <NodeBody>
                                                                        <NodeList>
                                                                           <Node NodeType="NodeList" epx="Sequence">
                                                                              <NodeId>ep2cp_Sequence_d1e1272</NodeId>
                                                                              <InvariantCondition>
                                                                                 <NOT>
                                                                                    <OR>
                                                                                       <AND>
                                                                                 ...
                                                                                 <NodeList>
                                                                                    ...
                                                                                    <Node NodeType="NodeList">
                                                                                       ...
                                                                                       <NodeBody>
                                                                                          <NodeList>
                                                                                             <Node NodeType="NodeList" epx="If">
                                                                                                <NodeId>ep2cp_If_d1e1446</NodeId>
                                                                                                <NodeBody>
                                                                                                   <NodeList>
                                                                                                      <Node NodeType="Empty" epx="Condition">
                                                                                                         <NodeId>ep2cp_IfTest</NodeId>
                                                                                                      ...
                                                                                                      <Node NodeType="NodeList" epx="Then">
                                                                                                         <NodeId>ep2cp_Sequence_d1e1465</NodeId>
                                                                                                         <InvariantCondition>
                                                                                                            <NOT>
                                                                                                               <OR>
                                                                                                                  <AND>
                                       ...
                                       <Node NodeType="NodeList">
                                          ...
                                          <NodeBody>
                                             <NodeList>
                                                <Node NodeType="NodeList" epx="If">
                                                   <NodeId>ep2cp_If_d1e1762</NodeId>
                                                   <NodeBody>
                                                      <NodeList>
                                                         <Node NodeType="Empty" epx="Condition">
                                                            <NodeId>ep2cp_IfTest</NodeId>
                                                         ...
                                                         <Node NodeType="Assignment" epx="Then">
