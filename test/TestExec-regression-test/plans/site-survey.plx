                                    ...
                                    <NodeList>
                                                                     ...
                                                                     <NodeBody>
                                                                        <NodeList>
                                                                           <Node NodeType="NodeList" epx="Sequence">
                                                                              <NodeId>ep2cp_Sequence_d1e988</NodeId>
                                                                              <InvariantCondition>
                                                                                 <NOT>
                                                                                    <OR>
                                                                                       <EQInternal>
                                                                                 ...
                                                                                 <NodeList>
                                                                                    ...
                                                                                    <Node NodeType="NodeList">
                                                                                       ...
                                                                                       <NodeBody>
                                                                                          <NodeList>
                                                                                             <Node NodeType="NodeList" epx="If">
                                                                                                <NodeId>ep2cp_If_d1e1162</NodeId>
                                                                                                <NodeBody>
                                                                                                   <NodeList>
                                                                                                      <Node NodeType="Empty" epx="Condition">
                                                                                                         <NodeId>ep2cp_IfTest</NodeId>
                                                                                                      ...
                                                                                                      <Node NodeType="NodeList" epx="Then">
                                                                                                         <NodeId>ep2cp_Sequence_d1e1181</NodeId>
                                                                                                         <InvariantCondition>
                                                                                                            <NOT>
                                                                                                               <OR>
                                                                                                                  <EQInternal>
                                       ...
                                       <Node NodeType="NodeList">
                                          ...
                                          <NodeBody>
                                             <NodeList>
                                                <Node NodeType="NodeList" epx="If">
                                                   <NodeId>ep2cp_If_d1e1478</NodeId>
                                                   <NodeBody>
                                                      <NodeList>
                                                         <Node NodeType="Empty" epx="Condition">
                                                            <NodeId>ep2cp_IfTest</NodeId>
